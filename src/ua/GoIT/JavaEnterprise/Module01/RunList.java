...
//        }
//        System.out.println("function add(index) to ArrayList(10,000): "+totalTime/VALUE_ITERATION+"µs");
//
...
//        }
//        System.out.println("function get(index) from ArrayList(10,000): "+totalTime/VALUE_ITERATION+"µs");
//
...
//        }
//        System.out.println("function remove(index) from ArrayList(10,000): "+totalTime/VALUE_ITERATION+"µs");
//
...
//        }
//        System.out.println("function containts(value) from ArrayList(10,000): "+totalTime/VALUE_ITERATION+"µs");
//
//        // add() function in ArrayList<>
//        for (int i = 1; i < VALUE_ITERATION; i++) {
...
//        }
//        System.out.println("function add(index) to ArrayList(100,000): "+totalTime/VALUE_ITERATION+"µs");
//
//        // get() function in ArrayList<>
//        for (int i = 1; i < VALUE_ITERATION; i++) {
...
//        }
//        System.out.println("function get(index) from ArrayList(100,000): "+totalTime/VALUE_ITERATION+"µs");
//
//        // remove() function in ArrayList<>
//        for (int i = 1; i < VALUE_ITERATION; i++) {
...
//        }
//        System.out.println("function remove(index) from ArrayList(100,000): "+totalTime/VALUE_ITERATION+"µs");
        ...
        System.out.println("function containts(value) from ArrayList(100,000): "+totalTime/VALUE_ITERATION+"µs");
